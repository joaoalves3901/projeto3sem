...
insert into estadoentrega (estado_entrega) values ('Confirmada/Espera'); 
insert into estadoentrega (estado_entrega) values ('Entregue'); 
insert into estadoentrega (estado_entrega) values ('Cancelado');


insert into condutor_has_anuncio (cond_anuncio_id, cond_id, estado_entrega_id) values (1,2,1); 
insert into condutor_has_anuncio (cond_anuncio_id, cond_id, estado_entrega_id) values (2,3,2); 
insert into condutor_has_anuncio (cond_anuncio_id, cond_id, estado_entrega_id) values (3,4,3); 
insert into condutor_has_anuncio (cond_anuncio_id, cond_id, estado_entrega_id) values (4,5,2); 

insert into anuncioestado (anuncio_estado) values ('Ativo'); 
insert into anuncioestado (anuncio_estado) values ('Desativo'); 


insert into anuncioinfo (anuncio_data, cliente_id, anuncio_estado_id, anuncio_id) values (curdate(), 1, 1, 1); 
insert into anuncioinfo (anuncio_data, cliente_id, anuncio_estado_id, anuncio_id) values (curdate(), 2, 2, 2); 
insert into anuncioinfo (anuncio_data, cliente_id, anuncio_estado_id, anuncio_id) values (curdate() , 3, 1, 3); 
insert into anuncioinfo (anuncio_data, cliente_id, anuncio_estado_id, anuncio_id) values (curdate(), 4, 1, 4); 
